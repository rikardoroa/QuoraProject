...
-----------------------DESPUES SE DEBE DESHABILITAR LA LINEA DE CODIGO  DESDE LA 193 A LA 203 EN LOGIN CONTROLLER PARA ACCEDER Y ACTUALIZAR LA FIRMA----------
...
INSERT INTO USUARIOS (NOMBREUSUARIO,FECHA_REGISTRO,NOMBRE,CEDULA,CARGO,AREA,ROL,PERMISOS, PASS, FIRMA_DIGITAL)VALUES('rikardoroa' ,GETDATE(),'Ricardo Roa',1067858108,'Coordinador De Sistemas','Sistemas','ADMINISTRADOR', 1, ENCRYPTBYPASSPHRASE('*xc/6789o—---+y','123'),NULL)
