SELECT    
	   	   				 MIDATA.[CONSECUTIVO REQUISICION] AS 'CONSECUTIVO REQUISICION',MIDATA.SOLICITANTE AS 'SOLICITANTE', MIDATA.AREA AS 'AREA', MIDATA.CARGO AS 'CARGO', MIDATA.[FECHA DE SOLICITUD] AS FECHA_SOLICITUD , MIDATA.[FECHA DE APROBACION] AS FECHA_APROBACION, MIDATA.[ITEM APROBADO] AS ITEMS_APROBADOS, COALESCE(MIDATA.[ITEM NO APROBADO],0) AS 'ITEMS NO APROBADOS',   
