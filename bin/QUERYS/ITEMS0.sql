...
WHERE ITEMSREQ.CEDULA = REQUISICIONES.CEDULA AND
 REQUISICIONES.CARGO = ITEMSREQ.CARGO AND  ITEMSREQ.IDREQ IS NULL  AND ITEMSREQ.CNSREQ IS NULL
 
  AND REQUISICIONES.CNSREQ='CNREQ1' AND REQUISICIONES.ID=1
